    ...
    <div className="flex flex-col w-full bg-[#111111] text-white">
      ...
      <section className="py-24 bg-[#0a0a0a] border-b border-white/5 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col gap-4">
          <span className="text-[#D4AF37] text-xs uppercase tracking-[0.3em] font-sans">Visual Archive</span>
          <h1 className="font-serif text-4xl sm:text-6xl">Production Gallery</h1>
          <p className="text-gray-400 max-w-xl mx-auto text-sm font-light">
            Staggered masonry archives comprising drone cinematography reels, fine wedding details, portraits, and commercial campaigns.
          </p>
        </div>
      </section>
