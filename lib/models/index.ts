...
const invoiceSchema = new Schema({
  ...
  createdBy: { type: String, default: 'Dasari Bharadwaj' },
  billedBy: { type: Schema.Types.Mixed, default: null },
  billedTo: { type: Schema.Types.Mixed, default: null },
  ...
  upiId: { type: String, default: 'dasaribharadwaj@ybl' },
  qrCodeUrl: { type: String, default: 'https://res.cloudinary.com/do4nuj2kh/image/upload/v1788764321/cfd483f1-1d47-42dc-a45d-4984ec18bb57_ka98b0.png' },
  upiNote: { type: String, default: 'Maximum of 1 lakh can be transferred via upi in a single day.' },
